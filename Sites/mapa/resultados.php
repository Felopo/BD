...
<section class="hero is-danger">
    <div class="hero-body">
        ...
        <?php if ($_POST['name']) {
            echo "<h3 class='subtitle has-text-centered'>A continuación se muestra el mapa con los resultados de la búsqueda para el usuario" . $_POST["name"] . "</h3>";
        } else 
...
<?php
    ...
    if ($_POST['name']){
        ...
        foreach ($date_filtered_messages as $message){
            ...
            } elseif ($message['receptant'] == $userId){
        ...
        if (!$vacio_capitanes){
            ...
            foreach ($lugares as $lugar) {
                if ($lugar == 'nombre'){
                    ...
                    $query7 = "SELECT latitud, longitud FROM coordenadas_puertos WHERE puerto = :puerto;"; 
            ...
            $query4 = "SELECT latitud, longitud FROM coordenadas_puertos WHERE puerto = :puerto;";
